...
public class ConversionController {
    ...
    // Загрузка файла для конвертации в PDF
    @PostMapping
    ...
    @GetMapping
    public Integer checkRecordsInDb() {
        return conversionTaskRepository.findAllByStatusEqualsAndOutboxSentEquals(ConversionTask.TaskStatus.UPLOADED, false).size();
    }
